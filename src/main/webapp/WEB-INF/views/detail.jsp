...
<head>
    ...
    <title>手机商城-${goodsInfo['goods'].goodsname}</title>
                    ...
                    <div id="leftbox">
                        <div id="showbox">
                            <c:forEach items="${goodsInfo['image']}" var="path">
                                <img src="http://localhost:8080/shop/shopimage/${path.path}" width="400" height="400"/>
                            </c:forEach>
                        </div>
                        <div id="showsum">
                        </div>
                                                    ...
                                                    <c:forEach items="${commentList}" var="comment">
                                                        <li id="li-comment-22" class="comment even thread-even depth-1"
                                                            ...
                                                            <div id="comment-22" class="comment_container">
                                                                <img class="head avatar avatar-60 photo "width="60" height="60" src="${pageContext.request.contextPath}/image/head.jpg" alt="">
