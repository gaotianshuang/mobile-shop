...
<div class="row">
    ...
    <div class="col-md-8">
        <ul class="nav nav-pills pull-right">
            <li><a href="${pageContext.request.contextPath}/chatrobot"> <i
                    class="fa fa-comment"></i> 留言
            </a></li>
            ...
            <li class="dropdown"><a class="a-color" href="${pageContext.request.contextPath}/info/list"
                                    ...
                                    aria-haspopup="true" aria-expanded="false"><i class="fa fa-file-text" ></i>  我的订单 <span
                    class="caret"></span></a>
                <ul class="dropdown-menu">
    ...
    <nav class="navbar navbar-default" id="header-nav-middle">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="${pageContext.request.contextPath}/main"><!-- <img alt="Brand" style="display: inline-block;" src="./image/tao.jpg" width="20" height="20"> --><span class="logo-word">手机商城</span></a>
            </div>
            ...
            <div class="collapse navbar-collapse"
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li><a class="a-color" href="${pageContext.request.contextPath}/category?cate=苹果">苹果</a></li>
                    <li><a  class="a-color" href="${pageContext.request.contextPath}/category?cate=华为">华为</a></li>
                    <li><a class="a-color" href="${pageContext.request.contextPath}/category?cate=小米">小米</a></li>
                    <li> <a class="a-color"  href="${pageContext.request.contextPath}/category?cate=vivo">vivo</a></li>
                    <li> <a class="a-color" href="${pageContext.request.contextPath}/category?cate=oppo">oppo</a></li>
                </ul>
